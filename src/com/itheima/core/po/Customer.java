...
public class Customer implements Serializable {
    ...
    private Date cute_createtime;            //创建时间
    private Integer start;                   //起始行
    private Integer rows;                    //索取行数
    ...
    public Date getCute_createtime() {
        return cute_createtime;
    }

    public void setCute_createtime(Date cute_createtime) {
        this.cute_createtime = cute_createtime;
    }
    ...
    public String toString() {
        return "Customer{" +
                ...
                ", cute_createtime=" + cute_createtime +
                ", start=" + start +
                ", rows=" + rows +
                '}';
    }
